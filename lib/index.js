...
function coreDepsInstalled(root) {
	return existsSync(join(root, "node_modules/@babel/core")) && existsSync(join(root, "node_modules/sharp/package.json")) && existsSync(join(root, "node_modules/jimp/package.json"));
}
