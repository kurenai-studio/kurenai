...
export type IPublicUndoService = Omit<IUndoService, 'reset' | 'push' | 'pushWithPrevious' | 'isApplying' | 'redo' | 'canRedo' | 'beginRecording' | 'endRecording' | 'cancelRecording' | 'hasActiveRecording'>;
