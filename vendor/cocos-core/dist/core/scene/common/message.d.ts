 ...
 * 可以获得事件名自动补全和参数类型推导。
 */
export interface IMessageManagerEvents extends IEditorEvents, INodeEvents, IComponentEvents, IScriptEvents, Omit<IAssetEvents, 'asset-refresh'>, ISelectionEvents, IGizmoEvents, ICameraEvents, ISceneViewEvents, IUndoEvents, IAnimationEvents, IReferenceImageEvents, ISceneEvents {
}
