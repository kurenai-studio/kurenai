...
export type IPublicNodeService = Omit<INodeService, keyof IServiceEvents | 'previewSetProperty' | 'cancelPreviewSetProperty' | 'setProperty' | 'reset' | 'resetProperty' | 'updatePropertyFromNull' | 'setNodeAndChildrenLayer' | 'setParent' | 'reorder' | 'copy' | 'paste' | 'duplicate' | 'cut' | 'preflightCreate' | 'queryClipboardState' | 'moveArrayElement' | 'removeArrayElement' | 'changeNodeLock' | 'queryNodesByAssetUuid' | 'queryNodesMissAsset'>;
/**
 * 节点的相关处理接口
 */
