...
export type IPublicTerrainService = Pick<ITerrainService, 'name' | 'isTerrainChange' | 'select' | 'unselect' | 'close' | 'saveAsset' | 'saveAssetDialog' | 'addAssetToComp' | 'read' | 'setMode' | 'setCurrentLayer' | 'setSculptSession' | 'setSculptBrushAsset' | 'setPaintBrushAsset' | 'setPaintSession' | 'saveManage' | 'addLayer' | 'removeLayer' | 'updateLayer' | 'readBlock'>;
