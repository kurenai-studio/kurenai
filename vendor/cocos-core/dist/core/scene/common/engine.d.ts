...
export interface IPublicEngineService extends Omit<IEngineService, 'initCustomLayer' | 'pause' | 'resume' | 'enterAnimationMode' | 'exitAnimationMode' | keyof IServiceEvents> {
}
