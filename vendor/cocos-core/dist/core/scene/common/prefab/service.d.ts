...
import type { IApplyPrefabChangesParams, ICreatePrefabFromNodeParams, IGetPrefabInfoParams, IIsPrefabInstanceParams, IRevertToPrefabParams, IUnlinkPrefabParams, IUnpackPrefabInstanceParams } from './params';
/**
 * 预制体事件类型
 */
