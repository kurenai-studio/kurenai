import { Color, IVec3, Material, MeshRenderer, Node, Quat, Vec3 } from 'cc';
...
declare class ControllerUtils {
    ...
    static createLine(parent: Node, startPos: Vec3, endPos: Vec3, color?: Color, opts?: Partial<IAddMeshToNodeOption>): MeshRenderer | null;
