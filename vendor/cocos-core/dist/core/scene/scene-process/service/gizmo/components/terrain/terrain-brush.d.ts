import { Material, Terrain, Texture2D, Vec2, Vec3 } from 'cc';
...
export declare class TerrainBrush {
    ...
    _rotation: number;
    get rotation(): number;
    getDelta(_x: number, _z: number): number;
    getBound(bbmin: Vec2, bbmax: Vec2): void;
    update(_terrain: Terrain, pos: Vec3): void;
}
...
export declare class TerrainCircleBrush extends TerrainBrush {
    ...
    _getTypeDefine(): Record<string, number>;
...
export declare class TerrainImageBrush extends TerrainBrush {
    ...
    static getColor(pixels: number[], width: number, height: number, u: number, v: number): number;
    static sampleImage(pixels: number[], width: number, height: number, u: number, v: number): number;
