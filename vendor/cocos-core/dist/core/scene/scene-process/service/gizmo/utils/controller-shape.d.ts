import { gfx, IVec3Like, Quat, Vec2, Vec3 } from 'cc';
...
declare class ControllerShape {
    ...
    calcDiscPoints(center: Readonly<Vec3>, normal: Readonly<Vec3>, radius: number, segments?: number): Vec3[];
    calcSectorPoints(center: Readonly<Vec3>, normal: Readonly<Vec3>, fromDir: Readonly<Vec3>, radian: number, radius: number, segments: number): Vec3[];
