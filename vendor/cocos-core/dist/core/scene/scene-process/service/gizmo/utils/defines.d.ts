...
declare const GizmoMouseEventBase: typeof CCEvent;
 ...
 */
export declare class GizmoMouseEvent<T extends Record<string, any> = {}> extends GizmoMouseEventBase {
    ctrlKey: boolean;
    shiftKey: boolean;
    altKey: boolean;
    metaKey: boolean;
...
export declare const flatPositionBitArrayPool: {
    key: number;
    value: Float32Array;
}[];
export declare function flatPosition(arr: Readonly<IVec3Like>[]): Float32Array;
export {};
