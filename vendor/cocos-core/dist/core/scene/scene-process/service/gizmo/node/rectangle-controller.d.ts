...
declare class RectangleController extends EditableController {
    ...
    isBorder(axisName: string): axisName is RectHandleType.Left | RectHandleType.Right | RectHandleType.Top | RectHandleType.Bottom;
    isCorner(axisName: string): axisName is RectHandleType.TopLeft | RectHandleType.TopRight | RectHandleType.BottomLeft | RectHandleType.BottomRight;
