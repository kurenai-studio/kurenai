...
export declare class CompManager {
    ...
    addRecycleComponent(uuid: string): void;
    removeRecycleComponent(uuid: string, comp: Component): void;
    /**
     * 在回收站中查询一个组件的实例
     * @param {*} uuid
     * @returns {cc.Component}
     ...
     * @param {String} uuid
     */
    queryDump(uuid: string): Promise<import("../../../common").IComponent | null>;
    /**
     * 调用Component身上的方法
     * @param {*} uuid
     * @param {*} name
...
declare const compManager: CompManager;
