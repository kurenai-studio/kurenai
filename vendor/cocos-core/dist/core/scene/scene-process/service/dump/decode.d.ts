...
import { INode, IScene, ITargetOverrideInfo } from '../../../common';
export declare function decodeMountedRoot(compOrNode: Node | Component, mountedRoot?: string): null | undefined;
/**
 * 解码一个场景 dump 数据
 * @param dump
 * @param scene
 ...
 * @param node
 */
export declare function decodeNode(dump: INode, node?: Node, excludeComps?: any): Promise<Node | null>;
/**
 ...
 * @param node
 */
export declare function decodePatch(path: string, dump: any, node: any): Promise<any>;
