...
import { IChangeNodeOptions } from '../../../common';
...
declare class NodeOperation {
    ...
    checkToAddPrefabAssetMap(node: Node): void;
     ...
     * @param nodeUUID uuid
     */
    applyPrefab(nodeUUID: string): Promise<IApplyPrefabInfo | null>;
     ...
     */
    replaceNewPrefabAssetWithClearedReference(node: Node, prefabAsset: string, clearedReference: Record<string, any>): Promise<Node | null>;
    /**
    ...
    private ensurePrefabAssetOnTree;
