...
import type { IAnimationCurveKeyData, IAnimationPropertyType, IAnimationValue } from '../../../common';
...
export type AnyCurve = ReturnType<AnyTrack['channels']> extends Iterable<infer T> ? T extends {
    curve: infer C;
} ? C : never : never;
