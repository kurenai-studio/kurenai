...
GL_METHOD(GetBufferSubData) {
  ...
  void *bufferPtr = buffer->Buffer()->Data();
...
GL_METHOD(Uniform1uiv) {
  ...
  GLuint *bufferPtr = static_cast<GLuint *>(data->Buffer()->Data());
...
GL_METHOD(UniformMatrix3x2fv) {
  ...
  GLfloat *bufferPtr = static_cast<GLfloat *>(data->Buffer()->Data());
...
GL_METHOD(VertexAttribI4iv) {
  ...
  GLint *bufferPtr = static_cast<GLint *>(values->Buffer()->Data());
...
GL_METHOD(VertexAttribI4uiv) {
  ...
  GLuint index = Nan::To<uint32_t>(info[0]).ToChecked();
  auto values = info[1].As<v8::ArrayBufferView>();
  GLuint *bufferPtr = static_cast<GLuint *>(values->Buffer()->Data());
...
GL_METHOD(ClearBufferfv) {
  ...
  GLfloat *bufferPtr = static_cast<GLfloat *>(values->Buffer()->Data());
