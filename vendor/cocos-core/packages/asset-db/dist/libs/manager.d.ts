 ...
 * @param uuid_url_path
 */
export declare function reimport(uuid_url_path: string): Promise<VirtualAsset | null | undefined>;
/**
 * 刷新一个资源或者资源目录
 * url 格式为 db://database_name/source_path@xxx
 * 绝对路径请使用系统分隔符，文件夹末尾不需要带分隔符（mac：/  win：\\）
 * @param uuid_url_path
 */
export declare function refresh(uuid_url_path: string): Promise<number | undefined>;
/**
 * 查找受影响的资源
 * @param asset
 */
...
export declare function queryMissingInfo(uuid: string): import("./info").MissingAssetInfo | null;
