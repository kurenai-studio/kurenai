...
exports.GooglePlayPackTool = void 0;
...
class GooglePlayPackTool extends default_1.NativePackTool {
    constructor() {
        super(...arguments);
     ...
     */
    async copyCustomIcons(customIconInfo) {
    ...
    async updateAndroidGradleValues() {
        ...
        if (fs.existsSync(gradlePropertyPath)) {
            ...
            const ndkPropertiesPath = utils_1.cchelper.join(options.ndkPath, 'source.properties');
...
exports.GooglePlayPackTool = GooglePlayPackTool;
