import { Vec2, Vec3, Quat } from '@cocos/engine/cocos/core/math';
/**
 ...
 */
export declare abstract class InputSource<T> {
    /**
 ...
 */
export declare class InputSourceAxis1D extends InputSource<number> {
    /**
 ...
 */
export declare class InputSourceAxis2D extends InputSource<Vec2> {
    /**
 ...
 */
export declare class InputSourceAxis3D extends InputSource<Vec3> {
    /**
 ...
 */
export declare class InputSourceQuat extends InputSource<Quat> {
    /**
 ...
 */
export declare class CompositeInputSourceAxis1D extends InputSourceAxis1D {
    /**
     * @en The input source object of positive 1D axis
     * @zh 1D 轴的正向的输入源对象
     */
    positive: InputSourceButton;
    /**
     * @en The input source object of negative 1D axis
     * @zh 1D 轴的负向的输入源对象
     */
    negative: InputSourceButton;
    constructor(options: {
        positive: InputSourceButton;
        negative: InputSourceButton;
    });
 ...
 */
export declare class CompositeInputSourceAxis3D extends InputSourceAxis3D {
    /**
     ...
     */
    zAxis: CompositeInputSourceAxis1D;
    constructor(options: {
        up: InputSourceButton;
        down: InputSourceButton;
        left: InputSourceButton;
 ...
 */
export declare class InputSourceButton extends InputSourceAxis1D {
    /**
 ...
 */
export declare class InputSourcePosition extends InputSourceAxis3D {
    /**
     * @en Get the signal value of the input source, which returns a Vec3 object.
     * @zh 获取输入源的信号值，该方法返回一个 Vec3 对象
     */
 ...
 */
export declare class InputSourceTouch extends InputSourceAxis1D {
    /**
