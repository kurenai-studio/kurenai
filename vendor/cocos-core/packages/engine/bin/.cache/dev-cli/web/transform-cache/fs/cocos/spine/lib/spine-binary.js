System.register("q-bundled:///fs/cocos/spine/lib/spine-binary.js", [], function (_export, _context) {
  "use strict";

  var DataInput, SkeletonBinary;
  _export({
    DataInput: void 0,
    SkeletonBinary: void 0
  });
  return {
    setters: [],
    execute: function () {
      _export("DataInput", DataInput = class DataInput {
        constructor(binary) {
      ...
      _export("SkeletonBinary", SkeletonBinary = class SkeletonBinary {
        static readString(input) {
        ...
        static readVarint(input, optimizePositive) {
          let value = 0;
          let shift = 0;
          let b;
          do {
