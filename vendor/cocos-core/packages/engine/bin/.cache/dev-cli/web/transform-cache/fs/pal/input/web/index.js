System.register("q-bundled:///fs/pal/input/web/index.js", ["./accelerometer-input.js", "./gamepad-input.js", "./handle-input.js", "./hmd-input.js", "./handheld-input.js", "./keyboard-input.js", "./mouse-input.js", "./touch-input.js"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_accelerometerInputJs) {
      ...
      _export({
        HandleInputDevice: _handleInputJs.HandleInputDevice,
        KeyEventType: _handleInputJs.KeyEventType
      });
