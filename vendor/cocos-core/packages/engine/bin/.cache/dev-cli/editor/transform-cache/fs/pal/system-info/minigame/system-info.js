System.register("q-bundled:///fs/pal/system-info/minigame/system-info.js", ["../../../../virtual/internal%253Aconstants.js", "pal/minigame", "../../../cocos/core/event/index.js", "../enum-type/browser-type.js", "../enum-type/language.js", "../enum-type/network-type.js", "../enum-type/operating-system.js", "../enum-type/platform.js", "../enum-type/feature.js", "../../../cocos/core/platform/debug.js", "../../utils.js"], function (_export, _context) {
  "use strict";

  var WECHAT, WECHAT_MINI_PROGRAM, XIAOMI, ALIPAY, TAOBAO, TAOBAO_MINIGAME, BYTEDANCE, OPPO, VIVO, HUAWEI, MIGU, HONOR, SUD, SUDV2, RUNTIME_BASED, TEST, DEBUG, minigame, EventTarget, BrowserType, NetworkType, OS, Platform, Feature, warn, versionCompare, SystemInfo, currentPlatform, isVersionGreaterOrEqualTo, originalGetSystemInfoSync, originalGetWindowInfo, _cachedSystemInfo, _cachedWindowInfo, systemInfo;
  ...
  return {
    setters: [function (_virtualInternal253AconstantsJs) {
      ...
      MIGU = _virtualInternal253AconstantsJs.MIGU;
      HONOR = _virtualInternal253AconstantsJs.HONOR;
      SUD = _virtualInternal253AconstantsJs.SUD;
      SUDV2 = _virtualInternal253AconstantsJs.SUDV2;
    ...
    }, function (_enumTypeLanguageJs) {}, function (_enumTypeNetworkTypeJs) {
    ...
    execute: function () {
      ...
      originalGetSystemInfoSync = minigame.getSystemInfoSync;
      originalGetWindowInfo = minigame.getWindowInfo;
      _cachedSystemInfo = originalGetSystemInfoSync.call(minigame);
      _cachedWindowInfo = originalGetWindowInfo == null ? void 0 : originalGetWindowInfo.call(minigame);
      ...
      SystemInfo = class SystemInfo extends EventTarget {
        ...
        triggerGC() {
          minigame.triggerGC == null || minigame.triggerGC();
        }
        openURL(url) {
          if (DEBUG) {
        ...
        exit() {
          minigame.exitMiniProgram == null || minigame.exitMiniProgram();
        }
        close() {
          this.exit();
        }
